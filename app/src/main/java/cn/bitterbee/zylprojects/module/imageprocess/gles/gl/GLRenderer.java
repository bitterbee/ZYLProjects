...
import cn.bitterbee.zylprojects.module.imageprocess.gles.kernelgen.KernelGenerator;
import cn.bitterbee.zylprojects.module.imageprocess.gles.kernelgen.KernelLangGLSL;
...
//				kernelSrcCode[KernelLangGLSL.SHADER_TYPE_VERTEX],
//				kernelSrcCode[KernelLangGLSL.SHADER_TYPE_FRAGMENT]);
		// edgeDetectShader = new GLShader(ctx, R.raw.image_process_edge_detect_v, R.raw.image_process_edge_detect_f);
		grayShader = new GLShader(ctx, R.raw.image_process_gray_blur_v, R.raw.image_process_gray_blur_f);
		gaussShader = new GLShader(ctx, R.raw.image_process_gauss_v_unused, R.raw.image_process_gauss_f_unused);
		dispShader = new GLShader(ctx, R.raw.image_process_disp_v, R.raw.image_process_disp_f);
		...
		if (useTestCases) {
			...
			bitmaps.add(BitmapFactory.decodeResource(ctx.getResources(), R.drawable.image_process_01_256));
    ...
    private void setupTestCases() {    	
		...
		imgSet[0] = R.drawable.image_process_01_256;
		bitmapNames.add("256x256");
		imgSet[1] = R.drawable.image_process_01_512;
		bitmapNames.add("512x512");
		imgSet[2] = R.drawable.image_process_01_1024;
		bitmapNames.add("1024x1024");
		imgSet[3] = R.drawable.image_process_01_2048;
